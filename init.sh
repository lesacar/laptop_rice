...
sudo pacman -S wmname scrot libnotify ttf-liberation $optional base-devel ttf-font-awesome libx11 libxft dunst picom libxinerama freetype2 fontconfig xwallpaper xorg-server xorg-xinit xorg-xrandr base-devel --noconfirm || echo "Something went wrong with pacman"
